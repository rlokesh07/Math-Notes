...
$y = a \sin b(x-c) + d$ & Amplitude = $\abs{a}$ & period = $\frac{2\pi}{b}$ & c value represents movement to the right & d moves the graph up and down            \\
$y = a \tan b(x-c) + d$ & vertical stretch      & period = $\frac{\pi}{b}$  & c value represents movement to the right & c value represents movement to the right \\
                        &                       &                           &                                          &                                         
\end{tabular}
\end{table}
\end{document}
